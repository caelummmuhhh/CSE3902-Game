...
{
    public class AquamentusDownwardProjectile : AquamentusBaseProjectile
    {
        private readonly IPlayer player;
        private Vector2 startPosition;
        private Vector2 directionVector;

        public AquamentusDownwardProjectile(Vector2 startPosition, IPlayer player) : base(startPosition)
        {
            this.player = player;
        ...
        public override void Move()
        {
            ...
            //float y = startPosition.Y + (directionVector.Y + projectionOffset) * timePassed * mainMovementSpeed + yStartDiff;
