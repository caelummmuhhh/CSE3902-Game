...
public class Game1 : Game
{
    ...
    public Game1()
    {
        ...
        {
            PreferredBackBufferWidth = GameConstants.BackBufferWidthFactor * Constants.UniversalScale,
            PreferredBackBufferHeight = GameConstants.BackBufferHeightFactor * Constants.UniversalScale
        };
