...
namespace MainGame.Commands
{
    public class PreviousItemCommand: ICommand
    {
        ...
        public PreviousItemCommand(Game game, IPlayer player, Block block, List<ISprite> blocks, Item item, List<ISprite> items)
        {
            this.game = game;
            this.item = item;
            this.items = items;
        ...
        public void Execute()
        {
            GlobalCounters.CurrentItemIndex = (GlobalCounters.CurrentItemIndex - 1 + items.Count) % items.Count;
