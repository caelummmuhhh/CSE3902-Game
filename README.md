# Controls
Keys are mapped as follows, note the digit keys have no debounce so users can hold and apply the effect continuously:
```
W,A,S,D: control the player movement
P: open and close meny
M: mute music
E: cause player to take damage
Q: quit
J,K: use item and sword, respectively

1: player obtain a boomerang
2: player obtain 1 bomb
3: player obtain arrow
4: player obtain bow
5: player obtain candle
6: player obtain 1 rupee
7: player is healed to max health
```
